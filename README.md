...
## 🛠️ Personal Projects
**[AI-Powered Chrome Extension for Enhanced Productivity](https://sizeofbits.github.io/)**
...
**Technologies used:** HTML, CSS, TailwindCSS, JavaScript, React, Vite, npm, LLMs (via Google Cloud).
